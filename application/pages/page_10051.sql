...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23133117382304706)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23133025137304706)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(23133117382304706)
,p_button_name=>'CLOSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(23133272187304706)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(23133025137304706)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23143070674304717)
,p_event_id=>wwv_flow_api.id(23133272187304706)
,p_event_result=>'TRUE'
