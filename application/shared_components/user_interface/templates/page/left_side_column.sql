...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(22831742439303881)
,p_theme_id=>42
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22832002596303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22832363451303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22832628751303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22832977080303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22833247847303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22833596917303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22833853008303884)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22834198643303890)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22834449953303890)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22834745990303890)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22835055763303890)
,p_page_template_id=>wwv_flow_api.id(22831742439303881)
