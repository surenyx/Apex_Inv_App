...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(22839125201303890)
,p_theme_id=>42
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22839425531303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22839724685303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22840078751303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22840337905303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22840651937303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22840937826303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22841251825303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22841586331303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22841819499303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22842141105303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22842456050303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22842793214303892)
,p_page_template_id=>wwv_flow_api.id(22839125201303890)
