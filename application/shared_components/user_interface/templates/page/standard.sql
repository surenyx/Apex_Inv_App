...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(22846567735303893)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22846872740303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22847141715303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22847494383303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22847733196303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22848061131303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22848350175303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22848673788303893)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22848918850303895)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22849277208303895)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22849513043303895)
,p_page_template_id=>wwv_flow_api.id(22846567735303893)
