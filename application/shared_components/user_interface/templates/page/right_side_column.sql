...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(22835449815303890)
,p_theme_id=>42
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22835793853303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22836063313303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22836348637303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22836660969303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22836942979303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22837249760303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22837538963303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22837884990303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22838175292303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22838494421303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(22838729767303890)
,p_page_template_id=>wwv_flow_api.id(22835449815303890)
