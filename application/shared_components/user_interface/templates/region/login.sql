...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22907063045303954)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22907330460303954)
,p_plug_template_id=>wwv_flow_api.id(22907063045303954)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22907686993303954)
,p_plug_template_id=>wwv_flow_api.id(22907063045303954)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22907981356303956)
,p_plug_template_id=>wwv_flow_api.id(22907063045303954)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22908281697303956)
,p_plug_template_id=>wwv_flow_api.id(22907063045303954)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22908523281303956)
,p_plug_template_id=>wwv_flow_api.id(22907063045303954)
,p_name=>'Sub Regions'
