...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22873775977303940)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22874046209303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22874333765303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22874694018303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22874933223303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22875256887303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22875504398303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22875810045303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22876182566303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22876463014303940)
,p_plug_template_id=>wwv_flow_api.id(22873775977303940)
,p_name=>'Sub Regions'
