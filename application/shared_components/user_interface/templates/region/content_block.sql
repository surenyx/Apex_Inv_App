...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22883235350303945)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22883532665303945)
,p_plug_template_id=>wwv_flow_api.id(22883235350303945)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22883859264303945)
,p_plug_template_id=>wwv_flow_api.id(22883235350303945)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22884149199303946)
,p_plug_template_id=>wwv_flow_api.id(22883235350303945)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22884421262303946)
,p_plug_template_id=>wwv_flow_api.id(22883235350303945)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22884751229303946)
,p_plug_template_id=>wwv_flow_api.id(22883235350303945)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22885095853303946)
,p_plug_template_id=>wwv_flow_api.id(22883235350303945)
,p_name=>'Sub Regions'
