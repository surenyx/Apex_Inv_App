...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22862249743303932)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22862599045303932)
,p_plug_template_id=>wwv_flow_api.id(22862249743303932)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22862816785303932)
,p_plug_template_id=>wwv_flow_api.id(22862249743303932)
,p_name=>'Sub Regions'
