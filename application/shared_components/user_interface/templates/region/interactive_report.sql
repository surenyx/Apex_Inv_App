...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22905226243303954)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22905582978303954)
,p_plug_template_id=>wwv_flow_api.id(22905226243303954)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22905851528303954)
,p_plug_template_id=>wwv_flow_api.id(22905226243303954)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22906135660303954)
,p_plug_template_id=>wwv_flow_api.id(22905226243303954)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22906409279303954)
,p_plug_template_id=>wwv_flow_api.id(22905226243303954)
,p_name=>'Sub Regions'
