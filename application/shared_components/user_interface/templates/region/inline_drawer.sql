...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22895274357303951)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22895580573303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22895828281303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22896164143303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22896417147303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22896725249303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22897046437303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22897383254303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22897655630303951)
,p_plug_template_id=>wwv_flow_api.id(22895274357303951)
,p_name=>'Sub Regions'
