...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22887462615303946)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22887739407303946)
,p_plug_template_id=>wwv_flow_api.id(22887462615303946)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22888084385303948)
,p_plug_template_id=>wwv_flow_api.id(22887462615303946)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22888358789303948)
,p_plug_template_id=>wwv_flow_api.id(22887462615303946)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22888681506303948)
,p_plug_template_id=>wwv_flow_api.id(22887462615303946)
,p_name=>'Sub Regions'
