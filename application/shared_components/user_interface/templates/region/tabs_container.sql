...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(22919012954303962)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22919357222303962)
,p_plug_template_id=>wwv_flow_api.id(22919012954303962)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(22919671420303962)
,p_plug_template_id=>wwv_flow_api.id(22919012954303962)
,p_name=>'Tabs'
